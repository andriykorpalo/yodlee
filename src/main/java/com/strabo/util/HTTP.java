...
public class HTTP {
	...
	public static String doGet(String url, String sessionTokens, String cobrandName, String apiVersion)
			throws IOException, URISyntaxException, InterruptedException {

		URL myURL = new URL(url);

		HttpURLConnection conn = (HttpURLConnection) myURL.openConnection();
		conn = setRequestProperty(conn, "GET", sessionTokens, cobrandName, apiVersion);
	 ...
	 * @throws URISyntaxException
	 */
	public static String doDelete(String url, String sessionTokens, String cobrandName, String apiVersion)
			throws IOException, URISyntaxException {
		
		
		URL myURL = new URL(url);
		HttpURLConnection conn = (HttpURLConnection) myURL.openConnection();
		conn = setRequestProperty(conn, "DELETE", sessionTokens.toString(), cobrandName, apiVersion);
		StringBuilder jsonResponse = new StringBuilder();
	...
	public static HttpURLConnection setRequestProperty(HttpURLConnection conn, String requestType,
			String token, String cobrandName, String apiVersion) {
		try {
